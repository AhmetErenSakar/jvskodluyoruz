...
const sectionc = document.querySelector('.section-center');
...
kategoriler.map((kategori) => {
  ...
  btn.addEventListener('click', (e) => {
    ...
    filtermenu.map(item => sectionc.appendChild(render(item)));
  })
...
const render = (data) => {
  ...
  <div class="menu-info">
    ...
    sectionc.appendChild(item);

    return item 

};
  menu.map(item => sectionc.appendChild(render(item)));
